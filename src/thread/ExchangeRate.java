...
public class ExchangeRate extends javax.swing.JFrame {
    ...
    private void addResponseToList(String base) {
        CurrencyConversionResponse response = 
            getResponse(API_PROVIDER + "/latest?" + "apikey=QTVT9mRETijxhVznzUxtBvOY0F7nq31A" + "&base=" + base);
        if (response != null) {
            rates.clear();
            for (String str : code) {
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addComponent(cmbBase, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(117, 117, 117)
                        .addComponent(lblclock, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void cmbBaseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbBaseActionPerformed
        ...
        if (index > 0) {
            ...
            model.clear(); // Assuming `model` is the model associated with your combo box or another relevant component
        }
